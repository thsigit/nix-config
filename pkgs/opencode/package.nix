{ lib, stdenvNoCC, bun, fetchFromGitHub, makeBinaryWrapper, models-dev, nodejs
, installShellFiles, versionCheckHook, writableTmpDirAsHomeHook, ripgrep, sysctl
}:
...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-HDc0bHoz4jPzHGMpU8w8snZSsB8m9DUnxJIA2M32jd4=";
  };
